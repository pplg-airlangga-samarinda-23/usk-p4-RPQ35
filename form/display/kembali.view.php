            ...
            <table class="table-auto border-collapse w-full">
                <thead>
                    <tr>
                        ...
                        <th class="bg-sky-300 p-2 text-center">judul buku</th>
                        <th class="bg-sky-300 p-2 text-center">tanggal pinjam</th>
                        <th class="bg-sky-300 p-2 text-center">tanggal pengembalian</th>
